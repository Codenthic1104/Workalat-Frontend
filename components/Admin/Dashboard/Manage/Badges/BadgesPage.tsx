...
export default function BadgesPage({ data }: any) {
                                ...
                                <div className="w-full text-center">
                                    <div className="pt-4">
                                        <div className="text-center">
                                            <h4 className="font-semibold uppercase text-[17px]">Add New Badge</h4>
                                        </div>

                                        <div className="w-full h-full">
                                            <form className="w-full">
                                                <div className="py-2 text-start">
                                                    <label htmlFor="badge" className="block pb-2 font-semibold">Badge</label>
                                                    <select
                                                        id="badge"
                                                        name="badge"
                                                    ...
                                                    >
                                                        ...
                                                        {
                                                            data?.pageItems?.map((bdg: any, i: number) => (
                                                                <option key={i} value={bdg?.badge}>{bdg?.badge}</option>
                                                            ))
                                                        }
                                                    </select>
                                                </div>
                                                ...
                                                <div className="py-2 text-start">
                                                    <label htmlFor="certificate" className="block pb-2 font-semibold">Certificate</label>
                                                    <input
                                                        type="text"
                                                        id="certificate"
                                                        name="certificate"
